...
// biMorp1: (Int, Long) => (Int, Writer[String, Long]) = category.universal.ProductCategory$$$Lambda$20936/1208558443@73822a70
```
...
// biMorp2: (Int, Long) => (Boolean, Writer[String, Boolean]) = category.universal.ProductCategory$$$Lambda$20936/1208558443@74736d4d
```
